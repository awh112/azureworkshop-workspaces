...
module "networking" {
  source  = "app.terraform.io/tuserworkshop/networking/azurerm"
  version = "0.0.1"
...
module "webserver" {
  source  = "app.terraform.io/tuserworkshop/webserver/azurerm"
  version = "0.0.1"
...
module "appserver" {
  source  = "app.terraform.io/tuserworkshop/appserver/azurerm"
  version = "0.0.1"
...
module "dataserver" {
  source  = "app.terraform.io/tuserworkshop/dataserver/azurerm"
  version = "0.0.1"
